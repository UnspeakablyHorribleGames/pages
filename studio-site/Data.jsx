...
const GAMES = [
  {
    title: "Hungry Dark", seed: 0, status: "In Development", statusTone: "violet",
  ...
  {
    title: "Untitled Second Thing", seed: 2, status: "In the Cauldron", statusTone: "absinthe",
    genres: ["Unannounced"],
  ...
  {
    title: "A Glint in Someone's Eye", seed: 3, status: "In the Cauldron", statusTone: "burgundy",
    genres: ["Unannounced"],
